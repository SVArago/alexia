...
urlpatterns = [
    ...
    url(r'^product/permanent/(?P<pk>\d+)/delete/$', views.PermanentProductDeleteView.as_view(),
    ...
    url(r'^product/temporary/(?P<pk>\d+)/delete/$', views.TemporaryProductDeleteView.as_view(),
